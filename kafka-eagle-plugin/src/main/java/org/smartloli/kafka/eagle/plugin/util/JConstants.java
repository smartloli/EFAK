...
public interface JConstants {
	...
	static String CREATE_TABLE_SQLITE_KE_TREND = "CREATE TABLE IF NOT EXISTS `ke_trend` (`cluster` varchar(64) NOT NULL,`key` varchar(64) ,`value` varchar(64),`hour` varchar(2),`tm` varchar(16) NOT NULL)";
