-- Manual copy of the collect-round upgrade.
-- Startup auto-applies classpath:sql/upgrade/V1__collect_round.sql
-- You do not need to run this file if the application has started at least once.
