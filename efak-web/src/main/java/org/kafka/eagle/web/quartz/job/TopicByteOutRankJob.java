    ...
    private void topicRank() {
        ...
        for (ClusterInfo clusterInfo : clusterInfos) {
            ...
            for (String topic : topics) {
                topicMBeanKey.put(KConstants.MBean.BYTEOUT + JmxConstants.MBEAN_KEY_SEPARATOR + topic, String.format(JmxConstants.BrokerServer.BYTES_OUT_PER_SEC_TOPIC.getValue(), topic));
            }
