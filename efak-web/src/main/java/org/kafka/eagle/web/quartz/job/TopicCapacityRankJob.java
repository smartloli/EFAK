        ...
        for (ClusterInfo clusterInfo : clusterInfos) {
            ...
            if (topics != null) {
                for (String topic : topics) {
                    ...
                    topicRankInfo.setTopicName(topic);
                    topicRankInfo.setTopicKey(KConstants.Topic.CAPACITY);
                    topicRankInfo.setTopicValue(String.valueOf(ksf.getTopicRecordCapacityNum(kafkaClientInfo, brokerInfos, topic)));
