        ...
        <main>
            <div class="container-fluid">
                ...
                <div class="alert alert-info alert-dismissable">
                    ...
                    <i class="fas fa-info-circle"></i> <strong>Select kafka topic, then edit the topic config, such as
                    clean topic data, modify topic config, describe topic config etc.</strong>
                </div>
                <!-- content body -->
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" name="ke_topic_alter" id="ke_topic_alter" value="add_config"
                                               checked="">Add Config
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="ke_topic_alter" id="ke_topic_delete"
                                               value="del_config">Delete Config
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="ke_topic_alter" id="ke_topic_describe"
                                               value="desc_config">Describe Config
                                    </label>
                                    <br/>
                                    <label for="inputError" class="control-label text-danger">
                                        <i class="fa fa-info-circle"></i> Select operate type when you getter/setter
                                        topic .
                                    </label>
                                </div>
                                <div class="form-group">
                                ...
                                <div id="div_topic_value" class="form-group">
                                    ...
                                    <label for="inputError" class="control-label text-danger">
                                        <i class="fa fa-info-circle"></i> Set the topic property value when you submit
                                        setter.
                                    </label>
                                </div>
                                <div id="div_topic_msg" class="form-group">
                                    ...
                                    <label for="inputSuccess" class="control-label text-danger">
                                        <i class="fa fa-info-circle"></i> Get result from server when you getter/setter
                                        topic .
                                    </label>
                                </div>
