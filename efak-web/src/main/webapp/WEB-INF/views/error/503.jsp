...
<head>
    ...
    <jsp:include page="../public/pro/title.jsp">
        <jsp:param value="503" name="loader"/>
    </jsp:include>

    <!-- Required common css -->
    <jsp:include page="../public/pro/css.jsp">
        <jsp:param value="error/404.css" name="css"/>
    </jsp:include>
</head>
...
<div class="wrapper">
    ...
    <main class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Errors</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="/"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">503</li>
                    </ol>
                </nav>
            </div>
        </div>
			...
			C360.647,451.083,349.251,457.661,338.164,454.689z"/>
                                    <g id="antenna">
                                        <line fill="#FFFFFF" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                                              ...
                                              stroke-miterlimit="10" x1="323.396" y1="236.625" x2="295.285"
                                              y2="353.753"/>
					...
					C278.993,441.286,286.836,447.55,296.315,452.273z"/>
                                    ...
                                    <g id="head">
                                        <ellipse transform="matrix(0.259 -0.9659 0.9659 0.259 -51.5445 563.2371)"
                                                 ...
                                                 stroke-linejoin="round"
                                                 stroke-miterlimit="10" cx="341.295" cy="315.211" rx="61.961"
                                                 ry="60.305"/>
				...
				s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z"/>
                    ...
                    <div class="col-md-6 align-self-center">
                        ...
                        <p>
                            It looks like you found a glitch in the <strong>EFAK</strong>...
                        </p>
                        <button id="efak_error_btn_404" class="btn btn-primary px-5">Go Home</button>
                    </div>
                </div>
            </div>
        </div>
...
<jsp:include page="../public/pro/script.jsp">
    <jsp:param value="main/error/404/gsap.min.js" name="loader"/>
    <jsp:param value="main/error/404/404.js?v=3.0.0" name="loader"/>
</jsp:include>
</body>
</html>
