...
<head>
    ...
    <jsp:include page="../public/pro/title.jsp">
        <jsp:param value="Modify" name="loader"/>
    </jsp:include>
...
<div class="wrapper">
    ...
    <main class="page-content">
        ...
        <!-- content body -->
        <!-- kafka table list -->
        <h6 class="mb-0 text-uppercase">Alarm Consumer List</h6>
        <hr/>
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    <table id="efak_alarm_consumer_tab" class="table table-striped table-bordered" style="width:100%">
                        <thead>
                        <tr>
                            <th>#ID</th>
                            <th>Group</th>
        ...
        <!-- delete consumer -->
        <div class="modal fade" id="alarm_consumer_remove" tabindex="-1" aria-labelledby="keModalLabel"
             aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="keModalLabel">Delete Consumer Group</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div id="efak_alarm_consumer_remove_content" class="modal-body"></div>
                    <div id="efak_alarm_consumer_remove_footer" class="modal-footer">
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- edit consumer -->
        <div class="modal fade" id="alarm_consumer_modify" tabindex="-1" aria-labelledby="keModalLabel"
             aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="keModalLabel">Edit Consumer</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form role="form" action="/alarm/consumer/modify/" method="post"
                              onsubmit="return contextConsumerModifyFormValid();return false;">
                            <div class="input-group mb-3"><span class="input-group-text">Lag</span>
                                <input id="ke_consumer_name_lag" name="ke_consumer_name_lag" type="text"
        ...
        <!-- detail -->
        <div class="modal fade" id="ke_alarm_consumer_detail" tabindex="-1" aria-labelledby="keModalLabel"
             aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="keModalLabel">Detail Consumer Group</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
...
<jsp:include page="../public/pro/script.jsp">
    ...
    <jsp:param value="main/alarm/modify.js?v=3.0.0" name="loader"/>
</jsp:include>
