            ...
            <div class="container">
                <div class="alert border-0 bg-light-success alert-dismissible fade show py-2">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            <div class="text-success"><strong>${Alarm_Submit_Status}</strong>&nbsp;&nbsp;<a
                                    class="btn btn-primary px-5 radius-30" href="/alarm/history"> <span
                                    class="ui-button-text">View Details</span></a></div>
                        </div>
                    </div>
