        ...
        <main>
            <div class="container-fluid">
                ...
                <div class="alert alert-danger alert-dismissable">
                    ...
                    <i class="fa fa-info-circle"></i> <strong>${Alarm_Config_Status}</strong> <a
                        class="btn btn-large btn-primary" href="/alarm/config"> <span class="ui-button-text">Create Again</span>
                </a>
                </div>
            </div>
        </main>
