...
public class KafkaOffsetServer {
	...
	public interface Iface {
		...
		public String query(String group, String topic, int partition, String clusterAlias) throws org.apache.thrift.TException;
	...
	public interface AsyncIface {
		...
		public void query(String group, String topic, int partition, String clusterAlias, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
	...
	public static class Client extends org.apache.thrift.TServiceClient implements Iface {
		...
		public String query(String group, String topic, int partition, String clusterAlias) throws org.apache.thrift.TException {
			send_query(group, topic, partition, clusterAlias);
			return recv_query();
		}

		public void send_query(String group, String topic, int partition, String clusterAlias) throws org.apache.thrift.TException {
	...
	public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
		...
		public void query(String group, String topic, int partition, String clusterAlias, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
			checkReady();
			query_call method_call = new query_call(group, topic, partition, clusterAlias, resultHandler, this, ___protocolFactory, ___transport);
		...
		public static class query_call extends org.apache.thrift.async.TAsyncMethodCall {
			...
			public query_call(String group, String topic, int partition, String clusterAlias, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client,
		...
		public static class getOffset_call extends org.apache.thrift.async.TAsyncMethodCall {
			...
			public getOffset_call(String clusterAlias, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory,
		...
		public static class sql_call extends org.apache.thrift.async.TAsyncMethodCall {
			...
			public sql_call(String sql, String clusterAlias, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory,
					org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
				super(client, protocolFactory, transport, resultHandler, false);
				this.sql = sql;
				this.clusterAlias = clusterAlias;
		...
		public static class getConsumer_call extends org.apache.thrift.async.TAsyncMethodCall {
			...
			public getConsumer_call(String clusterAlias, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory,
					org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
				super(client, protocolFactory, transport, resultHandler, false);
				this.clusterAlias = clusterAlias;
			}
		...
		public static class getConsumerPage_call extends org.apache.thrift.async.TAsyncMethodCall {
			...
			public getConsumerPage_call(String search, int iDisplayStart, int iDisplayLength, String clusterAlias, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client,
					org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
				super(client, protocolFactory, transport, resultHandler, false);
				this.search = search;
		...
		public static class getActiverConsumer_call extends org.apache.thrift.async.TAsyncMethodCall {
			...
			public getActiverConsumer_call(String clusterAlias, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory,
					org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
				super(client, protocolFactory, transport, resultHandler, false);
				this.clusterAlias = clusterAlias;
			}
	...
	public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
		...
		public static class query<I extends Iface> extends org.apache.thrift.ProcessFunction<I, query_args> {
			...
			public query_result getResult(I iface, query_args args) throws org.apache.thrift.TException {
				query_result result = new query_result();
				result.success = iface.query(args.group, args.topic, args.partition, args.clusterAlias);
				return result;
			}
		}
	...
	public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
		...
		public static class query<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, query_args, String> {
			...
			public void start(I iface, query_args args, org.apache.thrift.async.AsyncMethodCallback<String> resultHandler) throws TException {
				iface.query(args.group, args.topic, args.partition, args.clusterAlias, resultHandler);
			}
		}
	...
	public static class query_args implements org.apache.thrift.TBase<query_args, query_args._Fields>, java.io.Serializable, Cloneable, Comparable<query_args> {
		...
		public enum _Fields implements org.apache.thrift.TFieldIdEnum {
			GROUP((short) 1, "group"), TOPIC((short) 2, "topic"), PARTITION((short) 3, "partition"), CLUSTER_ALIAS((short) 4, "clusterAlias");
		...
		static {
			...
			tmpMap.put(_Fields.CLUSTER_ALIAS,
					new org.apache.thrift.meta_data.FieldMetaData("clusterAlias", org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
		...
		public query_args(String group, String topic, int partition, String clusterAlias) {
			this();
			this.group = group;
			this.topic = topic;
			this.partition = partition;
		...
		public query_args setClusterAlias(String clusterAlias) {
			this.clusterAlias = clusterAlias;
			return this;
		}
		...
		/**
		 * Returns true if field clusterAlias is set (has been assigned a value)
		 * and false otherwise
		 */
	...
	public static class getOffset_args implements org.apache.thrift.TBase<getOffset_args, getOffset_args._Fields>, java.io.Serializable, Cloneable, Comparable<getOffset_args> {
		...
		public getOffset_args(String clusterAlias) {
			this();
			this.clusterAlias = clusterAlias;
		}
	...
	public static class sql_args implements org.apache.thrift.TBase<sql_args, sql_args._Fields>, java.io.Serializable, Cloneable, Comparable<sql_args> {
		 ...
		 */
		public enum _Fields implements org.apache.thrift.TFieldIdEnum {
			SQL((short) 1, "sql"), CLUSTER_ALIAS((short) 2, "clusterAlias");
		...
		public sql_args(String sql, String clusterAlias) {
			this();
			this.sql = sql;
			this.clusterAlias = clusterAlias;
		}
	...
	public static class getConsumer_args implements org.apache.thrift.TBase<getConsumer_args, getConsumer_args._Fields>, java.io.Serializable, Cloneable, Comparable<getConsumer_args> {
		...
		public getConsumer_args(String clusterAlias) {
			this();
			this.clusterAlias = clusterAlias;
		}
	...
	public static class getConsumerPage_args implements org.apache.thrift.TBase<getConsumerPage_args, getConsumerPage_args._Fields>, java.io.Serializable, Cloneable, Comparable<getConsumerPage_args> {
		 ...
		 */
		public enum _Fields implements org.apache.thrift.TFieldIdEnum {
			SEARCH((short) 1, "search"), I_DISPLAY_START((short) 2, "iDisplayStart"), I_DISPLAY_LENGTH((short) 3, "iDisplayLength"), CLUSTER_ALIAS((short) 4, "clusterAlias");
		...
		public getConsumerPage_args(String search, int iDisplayStart, int iDisplayLength, String clusterAlias) {
			this();
			this.search = search;
			this.iDisplayStart = iDisplayStart;
	...
	public static class getActiverConsumer_args implements org.apache.thrift.TBase<getActiverConsumer_args, getActiverConsumer_args._Fields>, java.io.Serializable, Cloneable, Comparable<getActiverConsumer_args> {
		...
		public getActiverConsumer_args(String clusterAlias) {
			this();
			this.clusterAlias = clusterAlias;
		}
