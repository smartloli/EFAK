				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
									<form role="form" action="/cms/article/add/content"
										method="post"
										...
										<div class="form-group">
											...
											<div class="radio">
												<label> <input type="radio" name="article_type"
													id="optionsRadios1" value="新闻" checked="checked">新闻
												</label> <label> <input type="radio" name="article_type"
													id="optionsRadios2" value="公告">公告
												</label> <label> <input type="radio" name="article_type"
													id="optionsRadios3" value="常见问题">常见问题
												</label>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="radio">
												<label> <input type="radio" name="article_is_top"
													id="optionsRadios1" value="是" checked="checked">是
...
<jsp:include page="../public/script.jsp">
	<jsp:param value="main/add.js" name="loader" />
</jsp:include>
