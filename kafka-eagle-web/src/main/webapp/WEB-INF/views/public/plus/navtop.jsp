...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
	<a class="navbar-brand" href="/"><img src="/media/img/ke_login.png" style="width: 25px; border: 2px solid #fff; border-radius: 50%;" /> Kafka Eagle<sup>+</sup></a>
	...
	<div class="modal fade" aria-labelledby="keModalLabel" aria-hidden="true" id="ke_account_reset_dialog" tabindex="-1" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<!-- /.row -->
				<form role="form" action="/account/reset/" method="post" onsubmit="return contextPasswdFormValid();return false;">
	...
	<!-- Navtop Login -->
	<ul class="navbar-nav ml-auto ml-md-0">
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" id="userDropdown" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-user fa-sm fa-fw mr-1"></i>${LOGIN_USER_SESSION.realname}</a>
			<div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
				<a name="ke_account_reset" class="dropdown-item" href="#"><i class="fas fa-cogs fa-sm fa-fw mr-1"></i>Reset</a> <a class="dropdown-item" href="/account/signout"><i class="fas fa-sign-out-alt fa-sm fa-fw mr-1"></i>Signout</a>
			</div></li>
	</ul>
</nav>
