		...
		<main>
			<div class="container-fluid">
				...
				<div class="alert alert-success alert-dismissable">
					...
					<i class="fa fa-info-circle"></i> <strong>${Alarm_Submit_Status}</strong> <a class="btn btn-large btn-primary" href="/alarm/modify"> <span class="ui-button-text">View Details</span>
				</a>
				</div>
			</div>
		</main>
