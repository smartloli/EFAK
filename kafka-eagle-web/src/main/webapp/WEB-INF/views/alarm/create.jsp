			...
			<div class="row">
				<div class="col-lg-12">
					<div class="alert alert-info alert-dismissable">
						...
						<strong>Add an alert to the cluster.</strong>
					</div>
				</div>
			</div>
			<!-- /.row -->
									...
									<form role="form" action="/ke/alarm/create/form" method="post" onsubmit="return contextAlarmAddFormValid();return false;">
										<div class="form-group">
											...
											<label for="inputError" class="control-label text-danger">
												<i class="fa fa-info-circle"></i>
												Select the cluster type you need to alarm .
											</label>
										</div>
										<div id="ke_alarm_server_div" class="form-group">
											...
											<label for="inputError" class="control-label text-danger">
												<i class="fa fa-info-circle"></i>
												Such as zookeeper: dn1:2181,dn2:2181,dn3:2181.
											</label>
										</div>
										<div id="ke_alarm_topic_div" style="display: none" class="form-group">
											...
											<label for="inputError" class="control-label text-danger">
												<i class="fa fa-info-circle"></i>
												Write topic and capacity alarm value(unit is byte), such as {"topic":"ke_alarm_topic","capacity":1024}.
											</label>
										</div>
										<div class="form-group">
											...
											<label for="inputError" class="control-label text-danger">
												<i class="fa fa-info-circle"></i>
												Select the cluster level you need to alarm .
											</label>
										</div>
										<div class="form-group">
											...
											<label for="inputError" class="control-label text-danger">
												<i class="fa fa-info-circle"></i>
												Select the cluster alarm max times you need to alarm .
											</label>
										</div>
										<div class="form-group">
											...
											<label for="inputError" class="control-label text-danger">
												<i class="fa fa-info-circle"></i>
												Select the cluster alarm group you need to alarm .
											</label>
										</div>
