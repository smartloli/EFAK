	...
	<div id="layoutSidenav_content">
		<main>
			<div class="container-fluid">
				...
				<!-- modal -->
				<div class="modal fade" aria-labelledby="keModalLabel" aria-hidden="true" id="alarm_cluster_remove" tabindex="-1" role="dialog">
				...
				<!-- modify -->
				<div class="modal fade" aria-labelledby="keModalLabel" aria-hidden="true" id="alarm_cluster_modify" tabindex="-1" role="dialog">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<form role="form" action="/alarm/history/modify/" method="post"
									...
									<fieldset class="form-horizontal">
										...
										<div class="input-group mb-3">
											...
											<select class="custom-select" id="select2group" name="select2group" tabindex="-1" style="width: 100%; font-family: 'Microsoft Yahei', 'HelveticaNeue', Helvetica, Arial, sans-serif; font-size: 1px;"></select>
				...
				<!-- More then detail -->
				<div class="modal fade" aria-labelledby="keModalLabel" aria-hidden="true" id="ke_alarm_cluster_detail" tabindex="-1" role="dialog">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
