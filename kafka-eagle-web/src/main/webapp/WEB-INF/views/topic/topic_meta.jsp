			...
			<main>
				<div class="container-fluid">
					...
					<div class="alert alert-info alert-dismissable">
						...
						<i class="fa fa-info-circle"></i> <strong>Leader -1 indicates that the partition is not available or is empty.</strong> <br /> <i class="fa fa-info-circle"></i> <strong>Preferred Leader: true is preferred leader, false is risked leader.</strong> <br /> <i class="fa fa-info-circle"></i> <strong>Under Replicated: false is normal, true is lost replicas.</strong>
					</div>
					<!-- content body -->
					<div class="row">
							...
							<div class="card border-left-primary shadow h-100 py-2">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">LogSize (MSG)</div>
