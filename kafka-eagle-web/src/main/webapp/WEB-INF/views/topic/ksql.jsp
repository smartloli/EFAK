			...
			<main>
				<div class="container-fluid">
					...
					<div class="alert alert-info alert-dismissable">
						...
						<i class="fas fa-info-circle"></i> Sample <a href="http://www.kafka-eagle.org/articles/docs/quickstart/ksql.html" target="_blank">KSQL</a> query: <strong>select * from ke_topic where `partition` in (0,1,2) limit 10</strong><br /> <i class="fas fa-info-circle"></i> AutoComplete: Press <strong>Alt and /</strong>.
					</div>
					<!-- content body -->
					<div class="row">
						<div class="col-lg-12">
								...
								<div class="card-body">
									<nav>
										<div class="nav nav-tabs" id="nav-tab" role="tablist">
											<a class="nav-item nav-link active" id="ke_log_textarea" data-toggle="tab" href="#log_textarea" role="tab" aria-controls="log_textarea" aria-selected="true">Logs</a> <a class="nav-item nav-link" id="ke_result_textarea" data-toggle="tab" href="#result_textarea" role="tab" aria-controls="result_textarea" aria-selected="false">Result</a> <a class="nav-item nav-link" id="ke_ksql_history_textarea" data-toggle="tab" href="#ksql_history_textarea" role="tab" aria-controls="ksql_history_textarea"
												aria-selected="false">History</a>
										</div>
									</nav>
									<div class="tab-content" id="nav-tabContent">
										<div class="tab-pane fade show active" id="log_textarea" role="tabpanel" aria-labelledby="ke_log_textarea">
											<form>
												<textarea id="job_info" name="job_info"></textarea>
											</form>
										</div>
										<div class="tab-pane fade" id="result_textarea" role="tabpanel" aria-labelledby="ke_result_textarea"></div>
										<div class="tab-pane fade" id="ksql_history_textarea" role="tabpanel" aria-labelledby="ke_ksql_history_textarea">
					...
					<!-- More then detail -->
					<div class="modal fade" aria-labelledby="keModalLabel" aria-hidden="true" id="ke_sql_query_detail" tabindex="-1" role="dialog">
