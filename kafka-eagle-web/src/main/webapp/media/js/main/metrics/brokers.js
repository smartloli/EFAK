...
function brokerMetricData(filed, data) {
    var tr = '';
    if (data == null || data == undefined) {
        return tr;
    }
    tr += "<tr><td>" + filed + "</td><td><a class='btn btn-primary btn-xs'>" + data.meanRate.split("B")[0] + "</a></td><td><a class='btn btn-primary btn-xs'>" + data.oneMinute.split("B")[0]
