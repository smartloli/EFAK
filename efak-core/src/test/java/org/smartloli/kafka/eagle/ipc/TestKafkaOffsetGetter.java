...
public class TestKafkaOffsetGetter extends Thread {
    ...
    public void run() {
        ...
        for (String clusterAlias : clusterAliass) {
            ...
            // if
            // (SystemConfigUtils.getBooleanProperty("efak.sasl.enable"))
            // {
            ...
            // SystemConfigUtils.getProperty("efak.sasl.protocol"));
            // props.put(SaslConfigs.SASL_MECHANISM,
            // SystemConfigUtils.getProperty("efak.sasl.mechanism"));
            ...
            // ConsumerConnector consumer = Consumer<K,
            // V>.createJavaConsumerConnector(new
            ...
            if (SystemConfigUtils.getBooleanProperty("efak.sasl.enable")) {
                props.put(CommonClientConfigs.SECURITY_PROTOCOL_CONFIG, SystemConfigUtils.getProperty("efak.sasl.protocol"));
                props.put(SaslConfigs.SASL_MECHANISM, SystemConfigUtils.getProperty("efak.sasl.mechanism"));
            }
